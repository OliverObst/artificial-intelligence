"""Models for the spatial graph greedy best-first demo."""
...
class GraphGbfsTreeNode(AI9414Model):
    tree_id: str
    graph_node: str
...
class GraphGbfsExample(AI9414Model):
    name: str
    title: str
    subtitle: str
    graph: WeightedGraph
...
class GraphGbfsConfigData(AI9414Model):
    subtitle: str = "Instructor-supplied weighted graph."
    graph: WeightedGraph


class GraphGbfsConfigModel(BaseConfigModel):
    app_type: str = "graph_gbfs"
    data: GraphGbfsConfigData
