"""Models for the spatial graph UCS demo."""
...
class GraphUcsTreeNode(AI9414Model):
    tree_id: str
    graph_node: str
...
class GraphUcsExample(AI9414Model):
    name: str
    title: str
    subtitle: str
    graph: WeightedGraph
...
class GraphUcsConfigData(AI9414Model):
    subtitle: str = "Instructor-supplied weighted graph."
    graph: WeightedGraph


class GraphUcsConfigModel(BaseConfigModel):
    app_type: str = "graph_ucs"
    data: GraphUcsConfigData
